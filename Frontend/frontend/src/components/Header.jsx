            ...
            <Box sx={{ flexGrow: 1 }}>
                <AppBar position="static">
                    <Toolbar>
                        ...
                        {usuario_logeado?.usuario_logeado.user_type === "2" ? <Link to='/inicio'>AviCar</Link> : ""}
                        {usuario_logeado?.usuario_logeado.user_type === "1" ? <Link to='/inicioRecep'>AviCar</Link> : ""}
                        {usuario_logeado?.usuario_logeado.user_type === "0" ? <Link to='/inicioAdmin'>AviCar</Link> : ""}
                        {usuario_logeado ? "" : <Link to='/'>AviCar</Link> }
                        </Typography>
